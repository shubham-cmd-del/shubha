			...
			<Stack>
				<StackItem width="75%" lg-width="100%">
					...
					<Text as="h1" font="--headline1" md-font="--headline2" margin="10px 0">
						WEB DEVELOPEMENT IS THE MOST DEMANDING JOB AT CURRENT TIME.
					</Text>
				</StackItem>
			</Stack>
			...
			<Stack>
				...
				<StackItem width="50%" lg-width="100%">
					...
					<Text as="p" margin="16px 0" font="--base" max-width="400px">
						My name is Shubham, born and raised in India, worked as a professional web developer for more than 10 years, and awarded as best python developer in 2014.
					</Text>
				</StackItem>
			</Stack>
		</Section>
		<Section color="--dark">
			...
			>
				...
				<Text as="h3" font="--headline3" margin="10px 0">
					Is there any job for python or other language developers?
				</Text>
				<Text as="p" font="--lead" margin="10px 0" color="--greyD2">
					Yaa!! More than thousands of jobs are available. You just needs efforts and just to be passionate.
				</Text>
			</Box>
			<Box
				margin="36px 0 0 0"
			...
			>
				...
				/>
				<Text as="h3" font="--headline3" margin="10px 0">
					How much salary can be earned?
				</Text>
				<Text as="p" font="--lead" margin="10px 0" color="--greyD2">
					It all depends upon you if you are good enough and showed well every where, then it would be so easy to earn 22500 dollars per month.
				</Text>
			</Box>
			<Box
				margin="36px 0"
			...
			>
				...
				<Text as="p" font="--lead" margin="10px 0" color="--greyD2">
					All begins with effots without efforts nothing can be gained or achieved.Yaa it's easy but needs earlier efforts.
				</Text>
			</Box>
		</Section>
		<Section
